// ── PROJECT DATA ──────────────────────────────────────────────
  const projects = [
    {
      num: '01', domain: 'Fintech', name: 'Afropay (Swap)',
      ...
      tech: ['React.js', 'REST API', 'RBAC', 'KYC Workflows', 'JWT Auth', 'Modular CSS'],
    },
    {
      num: '02', domain: 'Government · DR Congo', name: 'Sonal Monitoring (DRC)',
      role: 'Frontend Developer',
      ...
      tech: ['Next.js', 'TypeScript', 'Redux', 'GraphQL', 'X-Road API', 'Tailwind CSS', 'Lucide React', 'React Icons'],
    },
    {
      num: '03', domain: 'Enterprise · CRM', name: 'Goldmark CRM',
      role: 'Frontend Developer',
      ...
      tech: ['React.js', 'REST API', 'RBAC', 'Modular CSS', 'Lead Pipelines', 'Calendar Integration'],
    },
    {
      num: '04', domain: 'SaaS · Education', name: 'School Management System',
      role: 'Frontend Developer',
      ...
      tech: ['React.js', 'Redux', 'REST API', 'Modular CSS', 'Multi-tenant SaaS', 'Python Trytond', 'React Hooks'],
    },
    {
      num: '05', domain: 'Productivity · Billing', name: 'Simplify Invoice',
      role: 'Frontend Developer',
      ...
      tech: ['React.js', 'Redux', 'REST API', 'PDF Generation', 'Modular CSS', 'Subscription Logic', 'React Hooks'],
    },
    {
      num: '06', domain: 'Travel · Booking', name: 'ZAPS Travels',
      role: 'Frontend Developer',
      ...
      tech: ['React.js', 'Material-UI (MUI)', 'CSS Modules', 'React Icons', 'Booking APIs', 'Dynamic Filters'],
    },
    {
      num: '07', domain: 'B2B · Intelligence', name: 'OpenSaas Platform',
      role: 'Frontend Developer',
      ...
      tech: ['React.js', 'Material-UI (MUI)', 'Custom Hooks', 'CSS Modules', 'API Integration', 'Figma-to-Code'],
    },
    {
      num: '08', domain: 'Compliance · Identity', name: 'E-KYC Platform',
      role: 'Frontend Developer',
      ...
      tech: ['React.js', 'REST API', 'RBAC', 'eKYC Workflows', 'Modular CSS', 'Lucide React', 'Audit Logs', 'Real-time Notifications'],
    },
    {
      num: '09', domain: 'Hospitality · Management', name: 'JUA Hotel Portal',
      role: 'Frontend Developer',
      ...
      tech: ['React.js', 'Modular CSS', 'REST API', 'RBAC', 'React Hooks', 'Lucide React', 'React Icons'],
    },
    {
      num: '10', domain: 'Facilities · Operations', name: 'Facility Management System',
      role: 'Frontend Developer',
      ...
      tech: ['React.js', 'TypeScript', 'REST API', 'RBAC', 'React Hooks', 'Lucide React', 'Data Visualization'],
    },
    {
      num: '11', domain: 'AI · Automation', name: 'Chatbot Platform',
      ...
      tech: ['MongoDB', 'Mongoose', 'Express.js', 'React.js', 'Node.js', 'TypeScript', 'CSS Modules', 'Session Management'],
    },
  ];
  ...
  projects.forEach((p, i) => {
    ...
    card.innerHTML = `
      ...
      <div class="project-tech">${p.tech.slice(0, 4).map(t => `<span class="tech-badge">${t}</span>`).join('')}${p.tech.length > 4 ? `<span class="tech-badge">+${p.tech.length - 4} more</span>` : ''}</div>
  ...
  function openModal(index) {
    ...
    tech.innerHTML = p.tech.map(t => `<span class="modal-tech-badge">${t}</span>`).join('');
  ...
  function attachHoverCursor() {
    document.querySelectorAll('a, button, .project-card, .skill-category, .stat-card, .modal-tech-badge').forEach(el => {
